...
***Plot:*** no plot
***Gameplay:*** Main character needs to pass through levels and earn maximum score. To success character needs to avoid moving obstacles and jump through different platforms. Game is over if player goes ragdoll or fall.
***Mechanics:***
1. Main character
	a. Walk
	b. Jump
